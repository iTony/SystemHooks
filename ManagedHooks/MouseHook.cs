...
namespace Kennedy.ManagedHooks
{
	...
	public class MouseHook : SystemHook
	{
		...
		public delegate void MouseEventHandler(MouseEvents mEvent, Point point,IntPtr hwnd);
		...
		protected override void HookCallback(int code, UIntPtr wparam, IntPtr lparam)
		{
			...
			switch(mEvent)
			{
				case MouseEvents.LeftButtonDown:
					GetMousePosition(wparam, lparam, ref x, ref y,ref hwnd);
                    MouseEvent(mEvent, new Point(x, y),hwnd);
					break;
